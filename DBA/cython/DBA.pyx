...
cdef int approximate_medoid_index(double[:,:] series, int w, double[:,:] cost_mat, double[:,:] delta_mat):
    cdef:
        int n_series = len(series)
        int n_samples_candidates = min_c_int(20,n_series)
        int n_samples_ss = min_c_int(20,n_series)
        # int n_samples_candidates = n_series//2
        # int n_samples_ss = n_series//2
        # int n_samples_ss = n_series
        # int n_samples_candidates = n_series
